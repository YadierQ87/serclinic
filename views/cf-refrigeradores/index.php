    ...
    <div class="widget-main">
        ...
        <ul class="nav nav-tabs " id="myTab">
            ...
            <li class="dropdown active">
                <a aria-expanded="true" data-toggle="tab" href="#refrigerador">
                    REFRIGERADORES
                </a>
            </li>
            <li class="dropdown">
        ...
        <div class="tab-content">
            ...
            <div id="refrigerador" class="tab-pane fade active in">
                                ...
                                [
                                    'detail' => function ($url, $model, $key)                        {
                                        return Html::a('<span class="fa fa-eye"></span>', '#', [
                                            'id' => 'actv-crear',
                                            'data-title'=>html_entity_decode("Ver Refrigerador:"." "),
                                            'data-toggle' => 'modal-mesa',
                                            'data-target' => '#modal-mesa',
                                            'title'=>'Detalles',
                                    ...
                                    'actualizar' => function ($url, $model, $key)                        {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#', [
                                            'id' => 'actv-crear',
                                            'data-title'=>html_entity_decode("Actualizar Refrigerador:"." "),
                                            'data-toggle' => 'modal-mesa',
                                            'data-target' => '#modal-mesa',
                                            'title'=>'Actualizar',
