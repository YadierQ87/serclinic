...
/* @var $searchModel app\models\CfActivimetroSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Activimetros';
...
<div class="widget-body">
    <div class="widget-main">
        ...
        <ul class="nav nav-tabs " id="myTab">
            <li class="dropdown " >
                <a aria-expanded="false"  href="<?= Url::to(['/cf-campana']) ?>">
            ...
            <li class="dropdown active">
                <a aria-expanded="true" data-toggle="tab"  href="#activimetro">
        ...
        <div class="tab-content">
            ...
            <div id="activimetro" class="tab-pane fade active in">
                                ...
                                [
                                    'detail' => function ($url, $model, $key)                        {
                                        return Html::a('<span class="fa fa-eye"></span>', '#', [
                                            'id' => 'actv-crear',
                                            'data-title'=>html_entity_decode("Ver Activimetro:"." "),
                                            'data-toggle' => 'modal-mesa',
                                            'data-target' => '#modal-mesa',
                                            'title'=>'Detalles',
                                    ...
                                    'actualizar' => function ($url, $model, $key)                        {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#', [
                                            'id' => 'actv-crear',
                                            'data-title'=>html_entity_decode("Actualizar Activimetro:"." "),
                                            'data-toggle' => 'modal-mesa',
                                            'data-target' => '#modal-mesa',
                                            'title'=>'Actualizar',
