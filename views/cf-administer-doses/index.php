...
<div class="col-lg-5">
    <?= Html::beginForm(['administrado'], 'post', ['data-pjax' => '0']); ?>

    <?= Html::submitButton(" Administrados", ['class' => 'btn btn-primary ',
        'name' => 'recep','id' => 'recep']) ?>
...
<div class="col-lg-2">
    ...
    <?= Html::submitButton(" A Administrar", ['class' => 'btn btn-primary','name' => 'aRecep','id' => 'aRecep','style'=>'margin-left:-4px']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['class' => 'yii\grid\ActionColumn',
                    'template' => '{detail} {administar} ','header'=>'Acciones',
                    'buttons' =>
                        [
                           ...
                           'administar' => function ($url, $model, $key)                        {
                                if($model->status=='Administrado'){
                                return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#', [
                                    'id' => 'actv-crear',
                                    'data-title'=>html_entity_decode("Editar Dosis:"),
                                    'data-toggle' => 'modal-mesa',
                                    'data-target' => '#modal-mesa',
                                    'title'=>'Actualizar ',
                               ...
                               if($model->status=='Preparado')
                               {
                                   return Html::a('<span class="fa fa-cog"></span>', '#', [
                                       'id' => 'actv-crear',
                                       'data-title'=>html_entity_decode("Administar Dosis:"." ".$model->id),
                                       'data-toggle' => 'modal-mesa',
                                       'data-target' => '#modal-mesa',
                                       'title'=>'Administrar',
