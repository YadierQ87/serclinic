...
<div class="col-lg-5">
        <?= Html::beginForm(['recepcionado'], 'post', ['data-pjax' => '0']); ?>

           <?= Html::submitButton(" Recepcionados", ['class' => 'btn btn-primary ',
               'name' => 'recep','id' => 'recep']) ?>
...
<div class="col-lg-2">
        <?= Html::beginForm(['index'], 'post', ['data-pjax' => '0']); ?>
            ...
            <?= Html::submitButton(" A Recepcionar", ['class' => 'btn btn-primary','name' => 'aRecep','id' => 'aRecep','style'=>'margin-left:-3px']) ?>
                ...
                'buttons' =>
                    [
                        ...
                        'recepcionar' => function ($url, $model, $key)                        {
                            if($model->status != "Recepcionado"){
                                return Html::a('<span class="fa fa-calendar-check-o"></span>', '#', [
                                    'id' => 'actv-crear',
                                    'data-title'=>html_entity_decode("Recepcionar Turno:"." ".$model->id),
                                    'data-toggle' => 'modal-mesa',
