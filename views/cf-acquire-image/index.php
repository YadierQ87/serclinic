...
<div class="col-lg-5">
    <?= Html::beginForm(['adquirido'], 'post', ['data-pjax' => '0']); ?>

    <?= Html::submitButton(" Adquiridos", ['class' => 'btn btn-primary ',
        'name' => 'recep','id' => 'recep']) ?>
...
<div class="col-lg-2">
    ...
    <?= Html::submitButton(" A Adquirir", ['class' => 'btn btn-primary','name' => 'aRecep','id' => 'aRecep','style'=>'margin-left:-6px']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['class' => 'yii\grid\ActionColumn',
                    'template' => '{detail}{adquirir}','header'=>'Acciones',
                    'buttons' =>
                        [
                            ...
                            'adquirir' => function ($url, $model, $key)                        {
                                return Html::a('<span class="fa fa-camera"></span>', '#', [
                                    'id' => 'actv-crear',
                                    'title' => 'Adquirir Imagen',
                                    'data-title'=>html_entity_decode("Adquirir imagen:"." ".$model->id),
                                    'data-toggle' => 'modal-mesa',
                                    'data-target' => '#modal-mesa',
