...
$this->title = 'Procesamiento de imagen';
...
<div class="col-lg-5">
    <?= Html::beginForm(['procesado'], 'post', ['data-pjax' => '0']); ?>

    <?= Html::submitButton(" Procesados", ['class' => 'btn btn-primary ',
        'name' => 'recep','id' => 'recep']) ?>
...
<div class="col-lg-2">
    ...
    <?= Html::submitButton(" A Procesar", ['class' => 'btn btn-primary','name' => 'aRecep','id' => 'aRecep','style'=>'margin-left:-7px']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['class' => 'yii\grid\ActionColumn',
                    'template' => '{detail} {procesar}','header'=>'Acciones',
                    'buttons' =>
                        [
                            ...
                            'procesar' => function ($url, $model, $key)                        {
                                return Html::a('<span class="fa fa-file-image-o"></span>', '#', [
                                    'id' => 'actv-crear',
                                    'title'=>'Procesar Imagen',
                                    'data-title'=>html_entity_decode("Procesar imagen para Consulta:"." ".$model->cf_medical_study_id),
                                    'data-toggle' => 'modal-mesa',
                                    'data-target' => '#modal-mesa',
