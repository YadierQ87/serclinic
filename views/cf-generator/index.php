...
/* @var $searchModel app\models\CfGeneratorSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Generadores';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cf-generator-index">


    <h3 class="pull-left" style="color: #2679B5"><?= Html::encode($this->title) ?></h3>

    <?= Html::a('Adicionar Generador','#',['id' => 'actv-crear',
        'data-toggle' => 'modal-mesa',
        'data-target' => '#modal-mesa',
        'data-url' => Url::to(['create']),
        'data-title'=>html_entity_decode("Adicionar Generador"),
        'class' => 'btn btn-primary pull-left',
        'style'=>'margin:10px'

    ]);
    ?>
    <?= Html::a('Elucion Diaria','#',['id' => 'actv-crear',
        'data-toggle' => 'modal-mesa',
        'data-target' => '#modal-mesa',
        'data-url' => Url::to(['cf-diary-elution/create']),
        'data-title'=>html_entity_decode("Elucion Diaria"),
        'class' => 'btn btn-primary pull-left',
    ...
    <?= GridView::widget([
       ...
       // 'filterModel' => $searchModel,
        ...
        'columns' => [
            ...
            // 'first_datetime_elucion',
            // 'first_activity_elucion',
             'last_datetime_elucion',
             'last_activity_elucion',
            [
            ...
            [
                ...
                'value' => function($data)                {
                    return ($data->status = 1) ? "Apto" : "No Apto";
                }
            ],
                    ...
                    [
                        'detail' => function ($url, $model, $key)                        {
                            return Html::a('<span class="fa fa-eye"></span>', '#', [
                                'id' => 'actv-crear',
                                'data-title'=>html_entity_decode("Ver Generador: ".$model->name),
                                'data-toggle' => 'modal-mesa',
                                'title'=>'Detalles',
                                'data-target' => '#modal-mesa',
                        ...
                        'actualizar' => function ($url, $model, $key)                        {
                            return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#', [
                                'id' => 'actv-crear',
                                'data-title'=>html_entity_decode("Actualizar Generador: ".$model->name),
                                'data-toggle' => 'modal-mesa',
                                'data-target' => '#modal-mesa',
                                'title'=>'Actualizar',
