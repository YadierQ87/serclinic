...
<div class="col-lg-5">
    <?= Html::beginForm(['entregado'], 'post', ['data-pjax' => '0']); ?>

    <?= Html::submitButton(" Entregados", ['class' => 'btn btn-primary ',
        'name' => 'recep','id' => 'recep']) ?>
...
<div class="col-lg-2">
    ...
    <?= Html::submitButton(" A Entregar", ['class' => 'btn btn-primary','name' => 'aRecep','id' => 'aRecep','style'=>'margin-left:-7px']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['class' => 'yii\grid\ActionColumn',
                    'template' => '{detail} {informar} ','header'=>'Acciones',
                    'buttons' =>
                        [
                            ...
                            'informar' => function ($url, $model, $key)                        {
                                return Html::a('<span class="fa fa-envelope-o"></span>', '#', [
                                    'id' => 'actv-crear',
                                    'data-title'=>html_entity_decode("Entregar Reporte:"." ".$model->id),
