...
/**
 * CfTypesEquipmentSearch represents the model behind the search form about `app\models\CfTypesEquipment`.
 */
class CfTypesEquipmentSearch extends CfTypesEquipment
{
    /**
     * @inheritdoc
     */
