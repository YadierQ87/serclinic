...
class AdminController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'allow' => true,
                        'actions' => ['index', 'logout', 'secciones-sitio', 'detalles-seccion', 'editar-seccion'],
                        'roles' => ['@'],
                    ],
                ],
            ],
    ...
    public function actionSeccionesSitio()
    {
        $searchModel = new \app\models\search\TextosInterfazSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('secciones-sitio', [
    ...
    {
        $model = \app\models\TextosInterfaz::findOne($id);
        return $this->render('detalles-seccion', ['model' => $model]);
    }
    ...
    public function actionEditarSeccion($id)
    {
        ...
        {
            return $this->redirect(['secciones-sitio']);
        }
        else
        {
            return $this->render('editar-seccion', ['model' => $model,]);
        }
    }
